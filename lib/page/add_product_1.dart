...
import '../untilities/searchLocation.dart';
import 'dart:async';
...
class add_product_1 extends StatefulWidget {
  @override
  State<add_product_1> createState() => _add_product_1State();
}

int _currentSliders = 0;
final CarouselController _controller = CarouselController();

class _add_product_1State extends State<add_product_1> {
                    ...
                    child: Column(
                      children: [
                        ...
                        InkWell(
                            ...
                            child: header_layout("Add New Product")),
                        SizedBox(
                          height: 20,
                        ),
                        Container(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  ...
                                  Visibility(
                                    visible: productAddressController.text != ''
                                        ? false
                                        : true,
                                    child: Container(
                                      width: MediaQuery.of(context).size.width,
                              ...
                              Column(
                                children: [
                                  ...
                                  Visibility(
                                    visible: productDeskriptionProductController
                                                .text !=
                                            ''
                                        ? false
                                        : true,
                              ...
                              Column(
                                children: [
                                  ...
                                  ListView.builder(
                                      ...
                                      scrollDirection: Axis.vertical,
                                      itemCount: productHighlightProduct.length,
                                      itemBuilder:
                                        ...
                                        return Column(
                                          children: [
                                            ...
                                            Visibility(
                                              visible: productHighlightProduct[
                                                          index] !=
                                                      ''
                                                  ? false
                                                  : true,
                                  ...
                                  InkWell(
                                    onTap: () {
                                      setState(() {
                                        if (productHighlightProduct.length >
                                            0) {
                                          productHighlightProduct.removeLast();
                                        }
                                      });
                                    },
                                    child: Container(
                                  ...
                                  Visibility(
                                    visible: productHighlightProduct.length != 0
                                        ? false
                                        : true,
                                    child: Container(
                                      width: MediaQuery.of(context).size.width,
                              ...
                              Column(
                                children: [
                                  ...
                                  ListView.builder(
                                      ...
                                      physics: NeverScrollableScrollPhysics(),
                                      scrollDirection: Axis.vertical,
                                      itemCount: productLinkYoutube.length,
                                      itemBuilder:
                                          (BuildContext context, index) {
                                        return Column(
                                          children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      setState(() {
                                        if (productLinkYoutube.length < 3) {
                              ...
                              Column(
                                ...
                                children: [
                                            ...
                                            onTap: () async {
                                              if (monday) {
                                                setState(() {
                                                  ...
                                                  productOperationalHoursTo.remove(
                                                ...
                                                setState(() {
                                                  ...
                                                  mondayTimeToText = time2!
                                                      ...
                                                      .replaceAll(')', '');
                                                  if (time2 != null) {
                                                    productOperationalHoursFrom.add(
                                                        'operationalHour[mondayFrom]');
                                  ...
                                  Visibility(
                                    visible:
                                        productOperationalHoursFrom.length != 0
                                            ? false
                                            : true,
                                    child: Container(
                                      width: MediaQuery.of(context).size.width,
                                  ...
                                  if (productNameController.text != '' &&
                                    ...
                                    box.write(
                                        ...
                                        productDeskriptionProductController
                                            .text);
                                    box.write(
                                        'category', categoryItemSelectedValue);
                                    box.write('placeName',
                                        productMeetingPointController.text);
