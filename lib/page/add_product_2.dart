...
class add_product_2 extends StatefulWidget {
  ...
  add_product_2(this.productHighlight, this.blackoutDate, this.photos,
      this.videos, this.operationalHourFrom, this.operationalHourTo);

  @override
  State<add_product_2> createState() => _add_product_2State(productHighlight,
      blackoutDate, photos, videos, operationalHourFrom, operationalHourTo);
}

int _currentSliders = 0;
final CarouselController _controller = CarouselController();

class _add_product_2State extends State<add_product_2> {
  List<String> productHighlight;
  List<String> blackoutDate;
  List<File> photos;
  List<String> videos;
  List<String> operationalHourFrom;
  List<String> operationalHourTo;
  _add_product_2State(this.productHighlight, this.blackoutDate, this.photos,
      this.videos, this.operationalHourFrom, this.operationalHourTo);
      ...
      setState(() {
        ...
        if (response.statusCode == 201) {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => add_product_3()));
        }
      });
    });
  }
                              ...
                              Column(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      maxLength: 15,
                                      controller: productProductPriceController,
                              ...
                              InkWell(
                                onTap: () {
                                  ...
                                  for (int i = 0; i < photos.length; i++) {
                                    List<int> imageBytes =
                                        photos[i].readAsBytesSync();
                                    base64Image.add('data:image/png;base64,' +
