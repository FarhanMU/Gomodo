...
class add_product_3 extends StatefulWidget {
  @override
  State<add_product_3> createState() => _add_product_3State();
}

int _currentSliders = 0;
final CarouselController _controller = CarouselController();

class _add_product_3State extends State<add_product_3> {
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Container(
                        width: MediaQuery.of(context).size.width,
                        child: Text(
                          'We have successfully added your product!',
