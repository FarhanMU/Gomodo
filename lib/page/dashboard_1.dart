...
class dashboard_1 extends StatefulWidget {
  @override
  State<dashboard_1> createState() => _dashboard_1State();
}

int _currentSliders = 0;
final CarouselController _controller = CarouselController();

class _dashboard_1State extends State<dashboard_1> {
                                                                  ...
                                                                  Column(
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          getNotification[index].createdAt.substring(
                                                                              0,
                                                                              10),
                                                                          style:
