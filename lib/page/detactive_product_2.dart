...
class detactive_product_2 extends StatefulWidget {
  @override
  State<detactive_product_2> createState() => _detactive_product_2State();
}

int _currentSliders = 0;
final CarouselController _controller = CarouselController();

class _detactive_product_2State extends State<detactive_product_2> {
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          'Deactivate Product Request Has Been Send to Our System',
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Container(
                        width: MediaQuery.of(context).size.width,
                        child: Text(
                          'Please follow the instruction on the email!',
