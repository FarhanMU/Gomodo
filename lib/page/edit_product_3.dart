...
class edit_product_3 extends StatefulWidget {
  @override
  State<edit_product_3> createState() => _edit_product_3State();
}

int _currentSliders = 0;
final CarouselController _controller = CarouselController();

class _edit_product_3State extends State<edit_product_3> {
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Container(
                        width: MediaQuery.of(context).size.width,
                        child: Text(
                          'We have successfully Edit your product!',
